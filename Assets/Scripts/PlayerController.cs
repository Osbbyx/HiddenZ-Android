...
public class PlayerController : MonoBehaviour
{
    ...
    float horizontal;
    float speed;
    public float speedCorrer = 9000f;
        ...
        
    {
        ...
        if (correr)
        {
            horizontal = TouchControl.playerTurnAxisTouch * correrVel;
        }else 
        {
            horizontal = TouchControl.playerTurnAxisTouch * playerSpeed;
        }
